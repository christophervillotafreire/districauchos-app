      ...
      <main className="container mx-auto max-w-lg p-4 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-3">
             ...
             <div>
               <p className="text-[9px] font-black text-slate-400 uppercase">Ventas Efec.</p>
          ...
          <div className="bg-white p-3 rounded-2xl border border-slate-200 shadow-sm flex items-center gap-3">
             ...
             <div>
               <p className="text-[9px] font-black text-slate-400 uppercase">Ventas Nequi</p>
          ...
          <div className="bg-emerald-600 p-3 rounded-2xl shadow-lg shadow-emerald-100 flex items-center gap-3 text-white">
             ...
             <div>
               <p className="text-[9px] font-black text-emerald-200 uppercase">Ganancia Efec.</p>
          ...
          <div className="bg-blue-600 p-3 rounded-2xl shadow-lg shadow-blue-100 flex items-center gap-3 text-white">
             ...
             <div>
               <p className="text-[9px] font-black text-blue-200 uppercase">Ganancia Bruta</p>
               <p className="text-xs font-black truncate">{formatCurrency(monthlyGrossProfit)}</p>
             </div>
          </div>
        </div>
              ...
              return (
                <button
                  ...
                  className={`
                    ...
                    ${hasData ? 'bg-blue-600 text-white shadow-sm shadow-blue-200' : 'bg-slate-50 text-slate-400'}
          ...
          <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden animate-in slide-in-from-top-4">
            <div className="bg-slate-900 p-4 flex justify-between items-center text-white">
              ...
              <button 
                ...
                className="flex items-center gap-1.5 bg-blue-600 px-4 py-2 rounded-full text-[10px] font-black uppercase"
              >
